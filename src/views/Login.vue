  ...
  methods: {
    state (id) {
      if (id === 'input-accountReg') {
        ...
        if (this.passwordReg.length < 4 || this.passwordReg.length > 20) {
          return false
        } else {
          return true
        }
      } else if (id === 'input-againpw') {
        if (this.againpw.length < 4 || this.againpw.length > 20) {
          return false
        ...
        if (this.passwordSignin.length < 4 || this.passwordSignin.length > 20) {
          return false
        } else {
          return true
        }
